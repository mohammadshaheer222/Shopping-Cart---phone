      ...
      <div>
        <div className="h-screen w-screen flex flex-col justify-center items-center space-y-10 ">
          ...
          <form className="flex flex-col space-y-5 overflow-hidden">
            <input
              className="w-64 input-field md:w-80"
              type="email"
              placeholder="Email"
            />
            <input
            ...
            />
            <a
              className="text-blue-500 text-xs text-end font-medium underline hover:text-blue-300 active:text-blue-600"
              href=""
            >
              Forgot Password?
            </a>
          ...
          <p className="line-break text-xs text-gray-500 md:text-sm">
            or Login with
          </p>
